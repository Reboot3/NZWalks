...
namespace NZWalks.API.Controllers
{
    ...
    public class WalksController : Controller
    {
        ...
        private async Task<bool> ValidateAddWalkAsync(Models.DTO.AddWalkRequest addWalkRequest)
        {
            ...
            if (walkDifficulty == null)
            {
                ...
                ModelState.AddModelError(nameof(addWalkRequest.WalkDifficultyId),
                   $"{nameof(addWalkRequest.WalkDifficultyId)} Data is invalid.");
            }
        ...
        private async Task<bool> ValidateUpdateWalkAsync
            (Models.DTO.UpdateWalkRequest updateWalkRequest)
        {
            ...
            if (walkDifficulty == null)
            {
                ...
                ModelState.AddModelError(nameof(updateWalkRequest.WalkDifficultyId),
                   $"{nameof(updateWalkRequest.WalkDifficultyId)} Data is invalid.");
            }
